...
export class VizjsViewService {
  ...
  folder_choice = "/public/test";//"/L4_logistics/Conception/rapports_test/test/test_mongodb";//"/L4_logistics/Services/Méthodes";//"/L4_logistics/Services/Exploitation";//"/L4_logistics/Conception/rapports_test/test/test_mongodb";
